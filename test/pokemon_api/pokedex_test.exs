defmodule PokemonApi.PokedexTest do
  ...
  describe "pokemons" do
    ...
    import PokemonApi.PokedexFixtures

    @invalid_attrs %{name: nil, type: nil, level: nil}
    ...
    test "create_pokemon/1 with valid data creates a pokemon" do
      valid_attrs = %{name: "some name", type: "some type", level: 42}
    ...
    test "update_pokemon/2 with valid data updates the pokemon" do
      pokemon = pokemon_fixture()
      update_attrs = %{name: "some updated name", type: "some updated type", level: 43}
